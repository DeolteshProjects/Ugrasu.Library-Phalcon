...
namespace Elios\Libraryreport\Controllers\Library\SintAnal;
...
class SintAnal {
    ...
    function getFinalArray() {
        ...
        (!empty($this->Author)) ? $this->ResultParseArray['Author'] = $this->Author : $this->ResultParseArray['Author'] = "Автор неизвестен.";
